...
export const tableOfContentItems = [
  {
    content: '\u2022 The Best of Nicefeel FC1592BK',
  ...
  },
  {
    ...
    id: `${nicefeelFC1592bkUrl}#pro-and-cons-nicefeelFC1592bk`
  },
  {
...
export const titleProps = {
  ...
  message: "Experience the pinnacle of oral care with Nicefeel's Cordless Water Flosser—a portable and rechargeable solution that effortlessly enhances gum health, teeth cleaning, and overall dental hygiene. With a 300ml detachable water tank, three cleaning modes, and a travel-friendly design, it's the perfect choice for efficient, hassle-free oral care, earning praise for its value, performance, and portability."
}
  ...
  items: [
    {
      ...
      itemContent: [
        "The Nicefeel FC1592BK features a high-pressure water pulse of 1800 times/minute, ensuring powerful and efficient cleaning that reaches areas traditional brushing can't.",
        "With three cleaning modes (Normal, Soft, Pulse), this water flosser offers versatile options to meet various oral cleaning needs, providing a personalized experience.",
        "Designed for convenience and portability, this cordless and rechargeable oral irrigator is perfect for travel, ensuring you can maintain your oral health on the go.",
        "Constructed with durability in mind, the Nicefeel FC1592BK boasts a 300ml detachable water tank, IPX7 waterproofing, and a reliable 1400mAh lithium battery for long-lasting use."
      ]
    }
  ]
}
  ...
  items: [
    {
      itemTitle: [
        ...
        "Efficient Gum Health and Teeth Cleaning: ",
        "User-Friendly Tips and Design",
        "Waterproof and Durable Construction",
      ],
      itemContent: [
        "The Nicefeel FC1592BK is designed to be cordless and portable, providing convenience for use at home or during travel. Its compact design enhances usability and portability.",
        "With a high-pressure water pulse of 1800 times/minute, 4 jet water flosser, and a 360° rotating long nozzle, this oral irrigator effectively cleans 99.99% of food residues, promoting gum health and thorough teeth cleaning. It is especially beneficial for individuals with periodontitis and braces.",
        "The water flosser comes with user-friendly tips, including suggestions to start with the soft mode for new users, using warm water for those with sensitive teeth, and the recommendation to change nozzles every three months for optimal hygiene. The 360° rotatable nozzle design allows for easy water filling, contributing to a hassle-free experience.",
        "Featuring IPX7 dual waterproofing, the Nicefeel FC1592BK ensures durability and protection against water exposure. The sturdy construction and attention to design details make it a reliable choice for oral care.",
      ]
    }
  ]
}