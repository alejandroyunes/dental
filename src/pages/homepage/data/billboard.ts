...
import AnimationBillboard from '../assets/images/irrigador-dental-max.webp'
import MobileImage from '../assets/images/irrigador-dental-max-mobile.webp'
